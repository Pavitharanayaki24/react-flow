...
const TopBar = ({ title, setTitle, undo, redo, cut, copy, paste, onPreview ,onEChange}: TopBarProps) =>  (
  <div className="absolute top-2 left-4 bg-white border border-gray-200 h-12 px-4 py-2 flex items-center space-x-2 rounded-lg z-10">
    ...
    <button onClick={onEChange }className="p-1 bg-black-100 text-black-600 rounded hover:bg-black-200"><FaBolt size={14} /></button>
  </div>
);
